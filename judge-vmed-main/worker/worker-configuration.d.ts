/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: d3db8cd81eecc10b8f9987c5ec65050b)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	INITIAL_ADMIN_EMAIL: "srijan.guchhait@gmail.com";
	ALLOWED_ORIGINS: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INITIAL_ADMIN_EMAIL" | "ALLOWED_ORIGINS" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY">> {}
}
